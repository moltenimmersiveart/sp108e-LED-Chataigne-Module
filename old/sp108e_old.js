...
function set_number_of_segments(int leds = 10)
{
	send_data("38". dec_to_even_hex(leds, true) ."00 2e 83");
}

function set_number_of_leds_per_segments(int segs = 1)
{
	// maximum 300
...
function change_white_channel_brightness(int brightness="255")
{
	// value 0 to 255
